<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisburseUser.aspx.cs" Inherits="CSMSys.Web.Controls.SRV.DisburseUser" %>
   ...
   <meta content="blendTrans(Duration=0.5)" http-equiv="Page-Enter" />
    ...
    <script language="javascript" type="text/javascript">
        function getbacktostepone() {
            window.location = "DisburseUser.aspx";
        }
        function onSuccess() {
            ...
            <asp:MultiView ID="MultiViewParty" runat="server">
                <asp:View ID="ViewInput" runat="server">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="4">
                            <tbody>
                                ...
                                <tr>        
                                    ...
                                    <td align="left">
                                        <asp:ListBox ID="lstserialids" runat="server" Width="70%"></asp:ListBox>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="feature-box-actionBar">
                        ...
                        <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Disburse" OnClick="btnSave_Click" />
                    </div>
                </asp:View>
                    ...
                    <asp:Panel ID="pnlSuccess" runat="server" Width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <span class="succesNotification">Loan Disbursement Edited Successfully.
                                            <br />
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" valign="middle">
                                        <span class="failureNotification">Error Occured in Loan Disbursement<br />
                                            Dialog will Close automatically within 2 Seconds </span>
                                    </td>
                                </tr>
                            </tbody>
