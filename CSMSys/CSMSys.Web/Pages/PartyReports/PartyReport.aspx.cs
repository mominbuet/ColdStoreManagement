...
namespace CSMSys.Web.Pages.PartyReports
{
    public partial class PartyReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                UIUtility.FillDropDownList(ddlReport, _ComboData.ReportList(), "Report");
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int intlValue = ddlReport.SelectedIndex;
                Response.Redirect("../PartyReports/PartyReportViewer.aspx?PID=" + txtpartycode.Text + "&ReportID=" + intlValue);
