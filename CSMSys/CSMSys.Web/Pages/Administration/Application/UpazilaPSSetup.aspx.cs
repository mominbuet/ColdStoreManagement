...
{
    public partial class UpazilaPSSetup : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            else
            {
                ...
                grvUpazilaPS.DataSource = dt;
                grvUpazilaPS.DataBind();
                grvUpazilaPS.Rows[0].Visible = false;
            }
        }
        #endregion

        #region Methods For Grid
        //protected void grvUpazilaPS_RowCommand(object sender, GridViewCommandEventArgs e)
        //{
        ...
        protected void grvUpazilaPS_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grvUpazilaPS.PageIndex = e.NewPageIndex;
            grvUpazilaPS.DataBind();
        }

        protected void grvUpazilaPS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if ((e.Row.RowType == DataControlRowType.DataRow) && (e.Row.Cells[1].Controls.Count > 0))
            {
                ...
                btnEdit.Attributes.Add("onClick", "javascript:ShowEditModal('" + ((Label)e.Row.Cells[1].Controls[1]).Text + "', '" + ((Label)e.Row.Cells[2].Controls[1]).Text + "', '" + ((Label)e.Row.Cells[3].Controls[1]).Text + "');");
        ...
        protected void grvUpazilaPS_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            int intDistributorID = Convert.ToInt32(((Label)grvUpazilaPS.Rows[e.RowIndex].FindControl("lblID")).Text.Trim().ToString());
