...
{
    public partial class LoanCollectionReport : System.Web.UI.Page
    {
        ...
        protected void btnReport_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("DeliveryReportViewer.aspx?code=" + txtpartycode.Text + "&bagLoans=" + txtBagloans.Text + "&carryingCost=" + txtCarryingCost.Text
