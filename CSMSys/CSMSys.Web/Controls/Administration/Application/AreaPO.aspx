<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaPO.aspx.cs" Inherits="CSMSys.Web.Controls.Administration.Application.AreaPO" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function okay() {
            ...
            if ((UIMODE == "NEW") || (UIMODE == "VIEW") || (UIMODE == "EDIT"))
    ...
    <form id="form1" runat="server">
        ...
        <div class="popup_Container">
            ...
            <div class="popup_Body">
                <asp:MultiView ID="MultiViewAreaPO" runat="server">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                ...
                                <asp:Panel ID="pnlView" runat="server" width="100%" Visible="false">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			                                ...
			                                <tr>
				                                <td align="left" style="Width:30%;">Code : </td>
				                                <td align="left" style="Width:70%;"><asp:Label ID="lblCode" runat="server" Text=""></asp:Label></td>
			                                </tr>
			                                <tr>
				                                <td align="left">Name : </td>
				                                <td align="left"><asp:Label ID="lblName" runat="server" Text=""></asp:Label></td>
			                                </tr>
			                                <tr>
				                                <td align="left">District : </td>
				                                <td align="left"><asp:Label ID="lblDistrict" runat="server" Text=""></asp:Label></td>
			                                </tr>
			                                <tr>
				                                <td align="left">Description : </td>
				                                <td align="left"><asp:Label ID="lblDescription" runat="server" Text=""></asp:Label></td>
			                                </tr>
			                                </tbody>
		                                </table>
                                </asp:Panel>
                                ...
                                <div class="feature-box-actionBar">
                                    ...
                                    <asp:Button ID="btnNew" runat="server" CssClass="button" Text="New" onclick="btnNew_Click" />
                                </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
